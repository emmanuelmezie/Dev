            ...
            <div class="row g-5">
                ...
                <div class="col-lg-8">
                    ...
                    <section class="py-5 border-bottom wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        Progressive Web Apps (PWA), etc. I help businesses to develop a responsive website, and write APIs used to develop production web/mobile applications.
                        </p>
                        <p>
                        Over the years, I have developed skills in analyzing and troubleshooting technical issues, as I support customers using advanced techniques to resolve issues. 
                        </p>
                        <p>
                        Adding VALUE has always been the watchword for me and will always remain the PUSH factor, that is, helping organizations to create and realize value for their investments in technology and people.
                        </p>
                        <div class="row mb-4">
                            <div class="col-sm-6 py-1">
                                <span class="fw-medium text-primary">Name:</span> Chime Emmanuel
                            </div>
                            <div class="col-sm-6 py-1">
                                <span class="fw-medium text-primary">Experience:</span> 11 Years
                            </div>
                            <div class="col-sm-6 py-1">
                                <span class="fw-medium text-primary">Phone:</span> +234 806 215 9230
                            </div>
                            <div class="col-sm-6 py-1">
                                <span class="fw-medium text-primary">Email:</span> me@chimeemmanuel.com
                            </div>
                            <div class="col-sm-6 py-1">
                                <span class="fw-medium text-primary">Address:</span> Umuahia, Abia State, Nigeria.
                            </div>
                            <div class="col-sm-6 py-1">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4 col-lg-6 col-xl-4">
                                <div class="d-flex bg-secondary p-4">
                                    <h1 class="flex-shrink-0 display-5 text-primary mb-0" data-toggle="counter-up">65</h1>
                                    <div class="ps-3">
                            ...
                            <div class="col-md-4 col-lg-6 col-xl-4">
                                <div class="d-flex bg-secondary p-4">
                                    <h1 class="flex-shrink-0 display-5 text-primary mb-0" data-toggle="counter-up">93</h1>
                                    <div class="ps-3">
                    ...
                    <section class="py-5 border-bottom wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="skill mb-4">
                                    <div class="d-flex justify-content-between">
                                        <p class="mb-2">CSS (Bootstrap/Materialize css) </p>
                                        <p class="mb-2">85%</p>
                                    </div>
                                    <div class="progress">
                                ...
                                <div class="skill mb-4">
                                    <div class="d-flex justify-content-between">
                                        <p class="mb-2">PHP (Procedural & OOP)</p>
                                        <p class="mb-2">90%</p>
                                    </div>
                                    <div class="progress">
